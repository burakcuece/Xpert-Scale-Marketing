        ...
        <div className="mt-20 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="relative p-8 bg-black border border-green-500/10 rounded-xl hover:border-green-500/30 transition-all h-full flex flex-col items-center text-center">
                <service.icon className="h-12 w-12 text-green-500 mb-6" />
